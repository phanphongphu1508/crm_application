	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				<c:forEach items="${groupedTasks}" var="userEntry">
					<div class="row">
						<div class="col-xs-12">
							<a href="#" class="group-title"> <img width="30"
								src="plugins/images/users/pawandeep.jpg" class="img-circle" />
								<span>${userEntry.key}</span> <!-- Hiển thị user.fullName -->
							</a>
						</div>
						<c:forEach items="${userEntry.value}" var="statusEntry">
							<div class="col-md-4">
								<div class="white-box">
									<h3 class="box-title">${statusEntry.key}</h3>
									<div class="message-center">
									<c:forEach items="${statusEntry.value}" var="task">
										<a href="#">
											<div class="mail-contnet">
												<h5>${task.taskName}</h5> <br>
												<span class="time">${task.startDate} - ${task.endDate}</span>
											</div>
										</a>
										</c:forEach>
									</div>
