		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
					...
					<li><a href="/crm_application/jobs" class="waves-effect"><i
			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="/crm_application/user-add" class="btn btn-sm btn-success">Thêm
							mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
									...
									<tbody>
										<c:forEach items="${listUsers}" var="user">
											<tr>
												...
												<td>${user.roleName}</td>
												<td>
													<a href="/crm_application/user-edit.jsp"class="btn btn-sm btn-primary">Sửa</a>
													<a href="/crm_application/users?id=${user.id}" class="btn btn-sm btn-danger">Xóa</a>
													<a href="/crm_application/user-details" class="btn btn-sm btn-info">Xem</a>
												</td>
											</tr>
										</c:forEach>
